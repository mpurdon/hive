defmodule Hive.Plugin.Builtin.Models.ReqLLMProvider do
  @moduledoc """
  Generic multi-provider API plugin using ReqLLM.

  Implements the `Hive.Plugin.Model` behaviour for API mode. Supports
  ...
  alias Hive.Runtime.{AgentLoop, ModelResolver}
