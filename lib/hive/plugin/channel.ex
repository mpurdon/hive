defmodule Hive.Plugin.Channel do
  @moduledoc """
  Behaviour for messaging channel plugins (Telegram, Discord, Slack, etc.).

  Channels are long-running GenServers under `Hive.Plugin.ChannelSupervisor`.
  ...
  **Outbound** (hive -> you): Channel attaches telemetry handlers for
  ...
  `Hive.Formattable` protocol for channel-appropriate formatting.
